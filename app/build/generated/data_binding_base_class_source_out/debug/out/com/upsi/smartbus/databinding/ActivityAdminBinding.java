...
public final class ActivityAdminBinding implements ViewBinding {
  ...
  private ActivityAdminBinding(@NonNull DrawerLayout rootView, @NonNull ImageButton btnDrawer,
  ...
  public static ActivityAdminBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAdminBinding((DrawerLayout) rootView, btnDrawer, contentFrame,
