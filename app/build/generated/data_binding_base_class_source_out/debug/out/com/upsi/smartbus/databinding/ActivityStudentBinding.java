...
public final class ActivityStudentBinding implements ViewBinding {
  ...
  private ActivityStudentBinding(@NonNull DrawerLayout rootView, @NonNull ImageButton btnDrawer,
  ...
  public static ActivityStudentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityStudentBinding((DrawerLayout) rootView, btnDrawer, contentFrame,
